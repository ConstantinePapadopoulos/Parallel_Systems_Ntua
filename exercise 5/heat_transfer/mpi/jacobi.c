...
int main(int argc, char ** argv) {
  ...
  int periods[2] = {
    0,
    0
  }; //periods={0,0}: the 2D-grid is non-periodic
  ...
  */
  ...
  gettimeofday( & tts, NULL);
   ...
   #ifdef TEST_CONV
   for (t=0;t<1000000 && !global_converged;t++) {
   #endif
   #ifndef TEST_CONV
   #undef T
   #define T 256
...
/*Add appr priate timers for computation*/
